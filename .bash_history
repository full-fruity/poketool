...
cd ../
rails -v
rails g model Monster no:integer name:string screen_name:string type1:string type2:string hp:integer atk:integer blk:integer ctc:integer def:integer spd:integer
rails db:migrate
exit
exit
ls-la
