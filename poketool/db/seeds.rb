...
json = ActiveSupport::JSON.decode(File.read('/usr/src/app/poketool/db/skills.json'))
json.each do |data|
...
json = ActiveSupport::JSON.decode(File.read('/usr/src/app/poketool/db/pokedex.json'))
json.each do |data|
